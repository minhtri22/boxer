...
def build_body(base_obj, target_root):
    ...
    target_weights = [
        ...
        # Reference head is lean, rectangular and visibly rugged rather than a
        # neutral MakeHuman face. Keep the edits symmetric and within the CC0
        # morph library so the final mesh stays a single coherent anatomical
        # surface.
